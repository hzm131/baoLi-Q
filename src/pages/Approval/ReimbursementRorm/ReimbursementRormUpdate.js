      ...
      <Modal
        ...
        footer={[
          ...
          <Button
            type="primary"
            key={2}
            onClick={()=>this.onSave(onSave)}>提交</Button>
        ]}
      >
            ...
            <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
              <Form.Item label="单据日期">
                {getFieldDecorator('billdate',{
                  ...
                  <DatePicker  placeholder="请选择单据日期" style={{ width: '100%' }} disabled={subShow}/>
                )}
              </Form.Item>
            </Col>
            ...
            <Col lg={6} md={12} sm={24}>
              <Form.Item label="总天数">
                {getFieldDecorator('totaldays',{
                  ...
                  <Input placeholder={"请输入总天数"} type={"Number"} disabled={subShow}/>
                )}
              </Form.Item>
            </Col>
            <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
              <Form.Item label="交通天数">
                ...
                })(<Input placeholder={"请输入交通天数"} type={"Number"} disabled={subShow}/>)}
              </Form.Item>
            </Col>
            <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
              <Form.Item label="工作天数">
                {getFieldDecorator('workdays',{
                  ...
                  <Input placeholder={"请输入工作天数"} type={"Number"} disabled={subShow}/>
                )}
              </Form.Item>
            </Col>
          </Row>
            ...
            <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
              <Form.Item label="交通费">
                {getFieldDecorator('travelfee',{
                  ...
                  <Input placeholder="请输入交通费" type={"Number"} onChange={this.onTravelfee} disabled={subShow}/>
                )}
              </Form.Item>
            </Col>
            <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
              <Form.Item label="税率">
                ...
                })(<Input placeholder="请输入税率" type='Number' onChange={this.onTaxrate} disabled={subShow}/>)}
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            ...
            <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
              <Form.Item label="补贴">
                ...
                })(<Input placeholder="请输入补贴" type='Number' disabled={subShow}/>)}
              </Form.Item>
            </Col>
            <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
            ...
            <Col lg={24} md={24} sm={24}>
              <Form.Item label="备注">
                {getFieldDecorator('memo',{
                  ...
                  <TextArea rows={3} disabled={subShow}/>
                )}
              </Form.Item>
            </Col>
          </Row>
